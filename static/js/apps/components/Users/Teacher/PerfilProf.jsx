...
function getRut() {
 ...
 class  PerfilProf extends React.Component {
	...
	insertarData() {
		...
		const dataTeacher = { rut ,pw};
		axios.post("/data-update-teacher-password", dataTeacher);
	...
	showpassword3(){
		...
		$.getJSON('/data-get-all-rut-teacher', (Teacher) => {
				   ...
				   this.setState({NomProf: filtroProf[0].nom_prof, email:filtroProf[0].email, telefono: filtroProf[0].telefono, contra: filtroProf[0].contraseña })
			})
		}
